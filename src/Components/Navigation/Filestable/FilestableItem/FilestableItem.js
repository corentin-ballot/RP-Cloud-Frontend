        ...
        return (
            <li className="filestable_content_item">
                ...
                <div className="filestable_content_item_icons">
                    {this.props.file.type !== "dir" && <a className="filestable_content_item_icons_item" href={"http://localhost/web/app.php/api/cloud/downloadfile?fileurl=" + encodeURI(this.props.file.url)}><i className="material-icons">file_download</i></a> }
